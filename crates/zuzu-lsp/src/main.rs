...
use lsp_types::request::{
    ...
    ResolveCompletionItem, SelectionRangeRequest, SemanticTokensFullRequest, Shutdown,
...
use lsp_types::{
    ...
    InlayHintServerCapabilities, Location, LogMessageParams, MarkedString, MarkupContent,
